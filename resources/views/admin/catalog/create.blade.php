<x-guest-layout>
        ...
        ">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item" style="color: black;">
                        <a href="{{ route('admin.catalog.index') }}">Catalog Management</a>
                    </li>
                    ...
                    <div style="display: flex; flex-direction: column; gap: 1.5rem;">
                        ...
                        <div>
                            <label for="title_1_qty" style="display: block; margin-bottom: 0.5rem; font-weight: 500; color: #374151;">
                                ...
                                <small style="display: block; color: #6b7280; font-size: 0.85rem;">How many {{ old('title_1', 'pcs') }} are in stock?</small>
                            </label>
                            <input type="number" name="title_1_qty" id="title_1_qty" value="{{ old('title_1_qty', 0) }}" min="0" step="1" required
                                   placeholder="150"
                                   style="width: 100%; padding: 0.75rem 1rem; border: 1px solid #d1d5db; border-radius: 0.5rem; font-size: 1rem; color: #111827;">
                            @error('title_1_qty')
                                <p style="color: #ef4444; font-size: 0.875rem; margin-top: 0.25rem;">{{ $message }}</p>
                    ...
                    <div style="display: flex; flex-direction: column; gap: 1.5rem;">
                        ...
                        <div>
                            <label for="title_2_qty" style="display: block; margin-bottom: 0.5rem; font-weight: 500; color: #374151;">
                                ...
                                <small style="display: block; color: #6b7280; font-size: 0.85rem;">How many {{ old('title_2', 'box') }} are in stock?</small>
                            </label>
                            <input type="number" name="title_2_qty" id="title_2_qty" value="{{ old('title_2_qty', 0) }}" min="0" step="1" required
                                   placeholder="10"
                                   style="width: 100%; padding: 0.75rem 1rem; border: 1px solid #d1d5db; border-radius: 0.5rem; font-size: 1rem; color: #111827;">
                            @error('title_2_qty')
                                <p style="color: #ef4444; font-size: 0.875rem; margin-top: 0.25rem;">{{ $message }}</p>
    ...
    <!-- Scripts (unchanged + minor improvement) -->
    <script>
        // Image preview
