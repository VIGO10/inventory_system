<x-guest-layout>
    ...
    <div style="padding: 2rem 1rem; max-width: 1400px; margin: 0 auto;">
        ...
        ">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item" style="color: black;">
                        <a href="{{ route('admin.supplier.catalog.index', $supplier->slug) }}">Catalog</a>
                    </li>
        ...
        <div style="
            ...
            padding: 2rem;
        ">
            <form action="{{ route('admin.supplier.catalog.update', [$supplier->slug, $catalog->id]) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
    ...
    <script>
        // Image preview - show existing or new
        ...
        document.getElementById('product_image').addEventListener('change', function(e) {
            ...
            if (this.files && this.files[0]) {
                ...
                // Re-show existing image if no new file selected
                @if($catalog->product_image)
                    preview.innerHTML = '<img src="{{ asset('storage/' . $catalog->product_image) }}" style="width:100%; height:100%; object-fit:cover;">';
                @else
                    preview.innerHTML = `
                        <div style="text-align: center; color: #9ca3af;">
                            <div style="font-size: 2.5rem;">📦</div>
